  ...
  <div class="app-main-content">
    ...
    <div>
      <el-table v-loading="loading" :data="invoiceList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="制单日期" key="invoiceDate" align="center" prop="invoiceDate" width="110" />
        <el-table-column label="审批/否决意见" key="returnAuditOpinion" align="center" prop="returnAuditOpinion"
          width="110" />
        <el-table-column label="备注" key="remark" align="center" prop="remark" width="140" />
      </el-table>
