            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="操作" align="center" width="280" class-name="small-padding fixed-width">
                  <template #default="scope">
                    ...
                    <el-tooltip content="关联部门" placement="top" v-if="scope.row.userId !== 1">
                      <el-button type="text" icon="CircleCheck" @click="handleGrantDept(scope.row)"
                                 v-hasPermi="['system:user:edit']"></el-button>
                    </el-tooltip>
                  </template>
               </el-table-column>
...
/** 跳转单位关联页面 */
function handleGrantDept(row) {
  const chooseUser ={};
  chooseUser.userId = row.userId;
  chooseUser.userName = row.userName
  chooseUser.nickName = row.nickName
  router.push({name:"ExtraUser", params: chooseUser});
};
/** 重置密码按钮操作 */
