    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport"
          v-hasPermi="['invoice:confirm:export']">导出</el-button>
      </el-col>
...
// 引入明细操作方法
import { listDetail, getDetail } from "@/api/value/add/confirm/detail/detail";
...
function handleExport() {
  proxy.download('invoice/confirm/export', {
    ...queryParams.value
