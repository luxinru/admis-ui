<template>
  <div class="app-main-content">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="View" :disabled="single" @click="handleDetail">明细</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Check" :disabled="multiple" @click="openAuditPage">审核</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport"
          v-hasPermi="['invoice:buildCostCheck:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="checkList" @selection-change="handleSelectionChange" :height="height" :row-class-name="tableRowClassName">
      ...
      <el-table-column label="单据编号" align="center" width="200">
        <template #default="scope">
          <router-link :to="{
            path: '/value/add/buildCostCheck/detail',
            query: {
...
// 单据状态
const invoiceStatusOptions = ref([{ codeProperty: '09', codeName: '造价核对' }]);
...
function handleExport() {
  proxy.download('invoice/buildCostCheck/export', {
    ...queryParams.value
