...
<script setup name="PhysicalDetail">
  ...
  // 引入单据操作方法
  import { getInvoice, updateInvoice } from "@/api/value/add/assetsquery/invoice/invoice";
  // 引入明细操作方法
  import { listDetail, getDetail, getValueList, addDetail, updateDetail } from "@/api/value/add/assetsquery/detail/detail";
  // 引入单位选择
