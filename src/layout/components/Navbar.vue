<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="appStore.device !== 'mobile'">
        ...
        <el-tooltip content="切换单位" effect="dark" placement="bottom">
          <div class="right-menu-item hover-effect">
            <svg-icon icon-class="post"  @click="getDeptSession" />
          </div>
        </el-tooltip>
  ...
  <el-dialog title="切换单位" :append-to-body='true' width="1000px" v-model="open" >
